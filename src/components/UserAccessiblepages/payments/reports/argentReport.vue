<template>
  <div class="p-6 w-full sm:w-auto">
    ...
    <h1 class="text-blue-800 text-md font-bold mt-5 mb-5">Overdue Urgents</h1>
...
export default {
  ...
  data() {
    return {
      ...
      activeTab: 0,
      tabs: ["Urgent", "Service", "Subsidy", "Argent"],
      activeTab1: 0,
      paymentTabs: ["Urgent", "Service", "Subsidy", "Argent"],
    };
  },
  ...
  created() {
    ...
    // this.apiClient.post("/argent-payments").then((response) => {
    //   console.log("response",response);
    //   this.allArgentPayments=response.data;
    // });
  },
  mounted() {
  ...
  methods: {
    ...
    //  this.apiClient.post("/argent-payments").then((response) => {
    //     console.log("response",response);
    //     this.argentPaymentsYear=response.data;
    //   });
    // },
