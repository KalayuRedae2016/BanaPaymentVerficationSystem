<template>
  <div class="p-6 w-full sm:w-auto">
    ...
    <h1 class="text-blue-800 text-md font-bold mt-5 mb-5">Overdue Subsidys</h1>
...
export default {
  ...
  data() {
    return {
      ...
      activeTab: 0,
      tabs: ["Subsidy", "Service", "Subsidy", "Argent"],
      activeTab1: 0,
      paymentTabs: ["Subsidy", "Service", "Subsidy", "Argent"],
    };
  },
  ...
  created() {
    ...
    // this.apiClient.post("/subsidy-payments").then((response) => {
    //   console.log("response",response);
    //   this.allSubsidyPayments=response.data;
    // });
  },
  mounted() {
  ...
  methods: {
    ...
    //  this.apiClient.post("/subsidy-payments").then((response) => {
    //     console.log("response",response);
    //     this.subsidyPaymentsYear=response.data;
    //   });
    // },
