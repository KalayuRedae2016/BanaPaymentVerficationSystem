  ...
  <div class="ml-10 mr-5 mt-8">
    ...
    <div class="flex">
      <button
        ...
        :class="`px-4 py-2 ${
          activeTab === index
            ? 'bg-gray-300  border-l border-r border-indigo-800 border-t border-indigo-800 rounded-lg text-indigo-700 fornt-extrabold'
      ...
      >
        ...
        <div class=" p-6 w-full sm:w-auto">
          <div class="flex flex-row space-x-5">
           ...
           <newBlockPayment></newBlockPayment>
...
<script>
import newBlockPayment from './NewPayments/newBlockPayment.vue'
import blockReport from './reports/blockReport.vue'
export default {
  components: {
    newBlockPayment,
    blockReport
  ...
  data() {
    return {
      ...
      activeTab: 0,
      tabs: ["Block Payment", "New Block Payment"],
    };
  },
  created(){
