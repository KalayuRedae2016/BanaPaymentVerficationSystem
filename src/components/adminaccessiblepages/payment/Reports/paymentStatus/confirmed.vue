<template>
  <div class="container mx-auto p-4 flex flex-col">
    ...
    <!-- {{ paymentType }} {{ year }} -->
    <p class="text-md  mb-5 -mt-1  text-blue-800 font-semibold">Users Who  Are Confirmed Regular This Year</p>
    <div
      class="border border-gray-300 flex flex-col bg-white rounded-lg shadow-md -mt-1 border-t border-r border-l border-gray-200"
    >
      <div class="p-4 mt-8">
        <div class="flex items-center justify-between mb-4">
          <div class="flex-1 mr-4">
            <input
              ...
              class="text-md w-full px-4 py-2 border border-gray-800 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
          <div></div>
        </div>
          ...
          <table class="w-full border-b border-indigo-500">
            ...
            <tbody>
              ...
              <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                ...
                <td class="p-3 text-md text-gray-700 whitespace-nowrap font-semibold">
                ...
                <td class="p-3 text-md whitespace-nowrap">
                  <button @click="seeDetail()"
                    class="flex items-center px-4 py-2 bg-white hover:bg-blue-400 text-blue-500 rounded"
                  >
                    <i class="mr-2 text-blue-500 fas fa-info-circle"></i>
                  </button>
                </td>
                <td class="p-3 text-md text-gray-700 whitespace-nowrap">
                  <button v-on:click="navigateProfile(searchClient._id)"
                    class="flex items-center px-4 py-2 bg-white hover:bg-blue-400 text-blue-500 rounded"
                  >
        ...
        <div class="flex flex-row mt-4 ">
          ...
          <div class=" ml-5 font-extrabold text-gray-500 text-sm mt-4"> <h1> Total Confirmed Capital <i class="fa fa-equals text-sm"></i><span class="text-teal-600 text-sm">50000000 Birr</span></h1></div>
        </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    seedDetail(){
       //show detail of the payment the client,and payment type,date,.....the bank and account used
    },
