          ...
          <div class="bg-white rounded-lg p-6 border border-cyan-500">
            ...
            <div class="">
              <form class="px-5 py-5">
                <!-- <img :src="imageData" alt="User Profile Image" class="w-64 h-64" /> //choose file will be here -->
          ...
          <div class="bg-white rounded-lg p-6 border border-cyan-500">
            <div class="fixed inset-0 flex items-center justify-center z-50">
              <div class="bg-white rounded-lg shadow-lg p-8 w-96">
                ...
                <p class="text-gray-600 text-2xl">User Detail Edited successfully</p>
                <button @click="editingSuccess=!editingSuccess"
    ...
    methods: {
      editDetail() {
        ...
        const userDetail = {
          ...
          dateOfBirth: this.localDateOfBirth,
          bankAccount: this.localBankAccount,
        };
        this.apiClient
          .put(`/api/v1/users/${this.localClientId}`, userDetail)
          .then((response) => {
