            ...
            <div class="bg-white border-t-2 border-l-2 border-b-2 border-dashed border-blue-500 flex flex-col w-1/2">
              <div class=" mb-5 flex flex-row justify-center">
                ...
                <div class="mx-5 mt-8 text-xs">
                  ...
                  <p class="text-blue-500 text-xs">ምሉእ ሽም/Full Name:<span class=" ml-2 text-yellow-800 text-xs">{{ user.fullName }} </span></p>
                  <p class="text-blue-500 text-xs">ኣድራሻ/Address:<span class=" ml-2 text-yellow-800 text-xs">{{ user.address }}</span></p>
                  <p class="text-blue-500 font-bold text-xs">ጾታ/Gender:<span class=" ml-2 text-yellow-800 font-bold text-xs">{{ user.gender }}</span></p>
