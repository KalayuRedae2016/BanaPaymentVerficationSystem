<template>
        ...
        >
          ...
          <div class=" p-6 w-full sm:w-auto">
            <div class="flex flex-row space-x-5">
             ...
             <newSubsidyPayment></newSubsidyPayment>
  ...
  <script>
  import newSubsidyPayment from './NewPayments/newSubsidyPayment.vue'
  import subsidyReport from './reports/subsidyReport.vue'
  export default {
    components: {
      newSubsidyPayment,
      subsidyReport
    ...
    data() {
      return {
        ...
        activeTab: 0,
        tabs: ["Subsidy Payment", "New Subsidy Payment"],
      };
    },
    created(){
