      ...
      <div v-if="sidebarVisible"
        ...
        <div class="flex flex-col space-y-4 bg-gray-500">
          ...
          <ul class="mt-3 flex flex-col list-none space-y-1">
            <!-- Dashboard -->
            <li @click="setActive('dashboard')" class="items-center bg-white hover:bg-gray-500 transition"
            ...
            <!-- Company Profile -->
            <li @click="setActive('companyProfile')" class="items-center bg-white hover:bg-gray-100 transition"
            ...
            <!-- Clients -->
            <li @click="setActive('clients')" class="items-center bg-white hover:bg-gray-100 transition"
            ...
            <!-- Send Message -->
            <li @click="setActive('message')" class="items-center bg-white hover:bg-gray-100 transition"
