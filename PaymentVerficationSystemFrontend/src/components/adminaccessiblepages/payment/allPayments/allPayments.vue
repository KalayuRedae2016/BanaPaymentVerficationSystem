        ...
        <div class="overflow-x-auto overflow-y-auto h-96">
          ...
          <table class="table-auto min-w-full border-collapse border-b border-gray-300 shadow-lg  border-t border-gray-300">
            ...
            <tbody class="divide-y divide-gray-200 bg-gray-50 overflow-y-auto">
              <tr v-for="searchPayment in searchedpayments" :key="searchPayment._id"
                ...
                <td class="p-4 flex flex-row space-x-2">
                  ...
                  <!-- <button
                  v-if="searchPayment.status==='confirmed' && role==='SuperAdmin'"
                  @click="
    ...
    >
      ...
      <div class="bg-white rounded-lg shadow-lg w-96">
        ...
        <div class="flex space-x-3 p-4">
          <button
            @click="confirmPaymentDelete(paymentToBeDeleted)" 
