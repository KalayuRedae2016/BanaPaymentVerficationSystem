<template>
  <div class="container mx-auto p-4 flex flex-col">
    ...
    <p class="text-2xl ml-5 mt-10 mb-5  text-indigo-500 font-semibold italic">Users Who  Are Rejected Regular payment</p>
    <div
      class="border border-indigo-800 flex flex-col bg-white rounded-lg shadow-md mt-8 border-t border-r border-l border-gray-200"
    >
      <div class="p-4 mt-8">
          ...
          <table class="w-full border-b border-indigo-500">
            <thead>
              <tr class="bg-gray-200">
                <th
                  class="w-24 p-3 text-2xl font-extrabold tracking-wide text-left text-indigo-800"
                >
                  No.
                </th>
                <th
                ...
                <th
                  class="w-32 p-3 text-2xl font-extrabold tracking-wide text-left text-indigo-800"
                >
                  Total Requested
                </th>
                <th
            ...
            <tbody>
              ...
              <td class="p-3 text-xl text-gray-700 whitespace-nowrap">
                ...
                <td class="p-3 text-2xl whitespace-nowrap">
        ...
        <div class="flex flex-row mt-4 ">
          ...
          <div class=" ml-5 font-extrabold text-gray-500 text-2xl mt-4"> <h1> Total Rejected Capital <i class="fa fa-equals text-2xl"></i><span class="text-teal-600 text-2xl">50000000 Birr</span></h1></div>
        </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {navigateProfile(clientId) {
