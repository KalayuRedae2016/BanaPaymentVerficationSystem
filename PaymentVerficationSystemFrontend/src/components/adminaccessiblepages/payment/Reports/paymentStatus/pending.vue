<template>
  <div class="container mx-auto p-4 flex flex-col">
    ...
    <!-- {{ paymentType }} {{ year }} -->
    <p class="text-md   mb-5  text-blue-800 font-semibold ">Users Who  Are Pending For Regular payment </p>
    <div
      class="border border-gray-300 flex flex-col bg-white rounded-lg shadow-md -mt-2 border-t border-r border-l border-gray-200"
    >
      <div class="p-4 mt-8">
