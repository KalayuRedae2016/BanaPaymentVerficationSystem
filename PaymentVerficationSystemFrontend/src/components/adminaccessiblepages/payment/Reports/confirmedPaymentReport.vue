  ...
  <div class="border border border-gray-400 mt-5">
    ...
    <div class="flex flex-col p-4 text-xs">
      <div class="flex flex-row border-b pb-5 border-blue-500">
        ...
        <select v-model="reportType" @change="changeReportType()" class="custom-select h-10">
      ...
      <div class="border border-gray-300 my-5 px-5 rounded-lg" v-if="reportType != 'allTime'">
        <div class="flex flex-col">
          <div class="mt-5 w-full flex flex-col space-y-3 md:flex-row md:space-x-3 md:space-y-0">
            ...
            <div>
              <select v-model="year" v-if="annuallySelected" @change="fetchPayments()" class="custom-select">
      ...
      <div
        ...
        <div class="flex flex-row space-x-2">
          <button @click="setReportParamsForCurrentPeriod('annually')"
          ...
          <button @click="setReportParamsForCurrentPeriod('semiAnnually')"
            class="h-12 lg:h-8 flex items-center bg-blue-100 text-black rounded-md px-4 py-2 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50">
            <i class="fas fa-calendar-minus text-sm lowercase mr-2 text-blue-500"></i>
            <span>This Semi</span>
          </button>

          <button @click="setReportParamsForCurrentPeriod('monthly')"
            class="h-12 lg:h-8 flex items-center bg-blue-100 text-black rounded-md px-4 py-2 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50">
        ...
        <button @click="setReportParamsForCurrentPeriod('weekly')"
          class="h-12 lg:h-8 flex items-center bg-blue-100 text-black rounded-md px-4 py-2 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50">
          <i class="fas fa-calendar-check text-sm lowercase mr-2 text-blue-500"></i>
          <span>This Week</span>
        </button>

        <button @click="setReportParamsForCurrentPeriod('daily')"
          class="h-12 lg:h-8 flex items-center bg-blue-100 text-black rounded-md px-4 py-2 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50">
      ...
      <div>
        ...
        <div class="flex flex-col border border-gray-300 rounded-lg mt-5" v-if="reportLength > 0">
          ...
          <div class="overflow-x-auto rounded- mx-5" v-if="reportLength > 0">
            ...
            <div class="my-5 mx-3">
              <a @click="showPaymentReportDetail = true"
              ...
              <div class="bg-gray-50 shadow-md rounded-lg p-4 border-r border-gray-300">
                ...
                <div class="grid lg:grid-cols-2 gap-6 text-sm ml-3">
                  ...
                  <div class="space-y-2 lg:border-r border-blue-500 pr-10">
                    ...
                    <div class="flex justify-between">
                      <span class="font-medium">{{ $t("totalBlock") }}</span>
                      <span class="bg-gray-100 px-2 py-1 rounded">{{ totalOrgBalance.totalBlockBankAccount || 0
                        }}</span>
                    </div>
                  </div>
                  ...
                  <div class="space-y-2 pr-10">
                    ...
                    <div class="flex justify-between">
                      <span class="font-medium">{{ $t("totalService") }}</span>
                      <span class="bg-gray-100 px-2 py-1 rounded">{{ totalOrgBalance.totalServiceBankAccount || 0
                        }}</span>
                    </div>
                  </div>
                </div>
