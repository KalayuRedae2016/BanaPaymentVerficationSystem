<template>
  ...
  <div class="bg-white p-6 w-full sm:w-auto border-t border-indigo-800 mt-1">
    <div class="flex flex-col lg:flex-row lg:space-x-2">
      ...
      <div class="">
        ...
        <select
          ...
          @change="fetchSemiYearlyPayments()"
          class=" ml-3 border border-gray-500 p-1 rounded-lg"
        >
      ...
      <select
        ...
        class="h-7 ml-4 border border-gray-500 p-1 rounded-lg"
      >
      ...
      <select
        ...
        v-if="weeklySelected"
        class="h-7 border border-gray-500 p-1 rounded-lg"
      >
    ...
    <table class="w-full border border-gray-300 mt-5">
      ...
      <tbody>
        <tr v-if="showTable">
          ...
          <td class="p-3 text-md text-gray-700 whitespace-nowrap">5000</td>
          <td class="p-3 text-md text-gray-700 whitespace-nowrap">4000</td>
          <td class="p-3 text-md text-gray-700 whitespace-nowrap">70</td>
          <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
            <button
              @click="confirmed()"
        ...
        <tr v-if="showTable">
          ...
          <td class="p-3 text-md text-gray-700 whitespace-nowrap">5000</td>
          <td class="p-3 text-md text-gray-700 whitespace-nowrap">--</td>
          <td class="p-3 text-md text-gray-700 whitespace-nowrap">--</td>
          <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
            <button
              @click="pending()"
    ...
    <div class="flex flex-row space-x-4 mt-5">
      <button
        class="h-8 flex items-center bg-indigo-600 text-white rounded-md px-4 py-2 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50"
      >
        <i class="fas fa-calendar-alt text-sm lowercase mr-2"></i>
        <span>This Year</span>
      </button>
      <button
        class="h-8 flex items-center bg-indigo-600 text-white rounded-md px-4 py-2 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50"
      >
        <i class="fas fa-calendar-minus text-sm lowercase mr-2"></i>
        <span>This Semi</span>
      </button>
      <button
        class="h-8 flex items-center bg-indigo-600 text-white rounded-md px-4 py-2 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50"
      >
        <i class="fas fa-calendar-week text-sm lowercase mr-2"></i>
        <span>This Mon</span>
      </button>
      <button
        class="h-8 flex items-center bg-indigo-600 text-white rounded-md px-4 py-2 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50"
      >
        <i class="fas fa-calendar-check text-sm lowercase mr-2"></i>
        <span>This Week</span>
      </button>
      <button
        class="h-8 flex items-center bg-indigo-600 text-white rounded-md px-4 py-2 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50"
      >
        <i class="fas fa-calendar-day text-sm lowercase mr-2"></i>
        <span>This Day</span>
      </button>
    </div>
