<template>
    <div class="flex flex-row bg-white p-6 w-full sm:w-auto">
      <div
        class="flex items-center ml-4 hover:bg-gray-300 h-7 w-32 mb-5"
        @click="goBack"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="w-6 h-6 mr-2 text-indigo-800 cursor-pointer"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
      ...
      <div class="breadcrumbs text-lg mb-5 flex flex-row">
    ...
    <div class="ml-5 mr-5 mb-3 mt-3">
      <hr class="md:min-w-full border border-gray-400" />
    </div>
    <div class="bg-white p-6 w-full sm:w-auto">
      ...
      <h1 class="text-indigo-800 font-bold">Total amount:123000000</h1>
    </div>
  </template>
  <script>
  export default {
    ...
    methods: {
      ...
      goToGruopPayment() {
        ...
        const reportType = "annaul";
        const year = "2023";
  
        this.$router.push({
          name: "group-payments",
          query: { paymentType, year, reportType },
