                ...
                <div class="space-y-4 mr-0 lg:mr-32 ml-5">
                  <div class="flex justify-between text-gray-700">
                    ...
                    <span class="text-gray-900">{{
                      affectedUserOffset.amount | currency
                    }}</span>
                  </div>
                  ...
                  <div class="flex justify-between text-gray-700">
                    ...
                    <span class="text-gray-900">{{
                      affectedUserOffset.fromBankType
                    }}</span>
                  </div>
                  ...
                  <div class="flex justify-between text-gray-700">
                    ...
                    <span class="text-gray-900">{{
                      affectedUserOffset.transferCase
                    }}</span>
                  </div>
                  ...
                  <div class="flex justify-between text-gray-700">
                    ...
                    <span class="text-gray-900">{{
                      affectedUserOffset.transferDate
                    }}</span>
                  </div>
                  ...
                  <div class="flex justify-between text-gray-700">
                    ...
                    <span class="text-gray-900">{{
                      affectedUserOffset.transferType
                    }}</span>
                  </div>
                </div>
              </div>
              <div v-if="action === 'Update'">
                ...
                <div class="space-y-4 mr-0 lg:mr-32 ml-5">
                  <div class="flex justify-between text-gray-700">
                    <span class="font-medium">Amount:</span>
                    <span class="text-gray-900">{{
                      affectedUserOffsetAfterUpdate.amount | currency
                    }}</span>
                  </div>
                  ...
                  <div class="flex justify-between text-gray-700">
                    <span class="font-medium">From Bank:</span>
                    <span class="text-gray-900">{{
                      affectedUserOffsetAfterUpdate.fromBankType
                    }}</span>
                  </div>
                  ...
                  <div class="flex justify-between text-gray-700">
                    <span class="font-medium">Reason:</span>
                    <span class="text-gray-900">{{
                      affectedUserOffsetAfterUpdate.reason
                    }}</span>
                  </div>
                  ...
                  <div class="flex justify-between text-gray-700">
                    <span class="font-medium">Reference Number:</span>
                    <span class="text-gray-900">{{
                      affectedUserOffsetAfterUpdate.refNumber
                    }}</span>
                  </div>
                  ...
                  <div class="flex justify-between text-gray-700">
                    <span class="font-medium">Transfer Case:</span>
                    <span class="text-gray-900">{{
                      affectedUserOffsetAfterUpdate.transferCase
                    }}</span>
                  </div>
                  ...
                  <div class="flex justify-between text-gray-700">
                    <span class="font-medium">Transfer Date:</span>
                    <span class="text-gray-900">{{
                      affectedUserOffsetAfterUpdate.transferDate
                    }}</span>
                  </div>
                  ...
                  <div class="flex justify-between text-gray-700">
                    <span class="font-medium">Transfer Type:</span>
                    <span class="text-gray-900">{{
                      affectedUserOffsetAfterUpdate.transferType
                    }}</span>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    detail(logData) {
      ...
      this.affectedUserOffset = actionMapping[logData.action] || null;
      if (logData.action === "Update") {
        this.affectedUserOffsetAfterUpdate =
          logData.affectedData.updatedData;
      }

      console.log(" affectedUserOffset", this.affectedUserOffset);
    },
    async fetchPaymentSettingLogs() {
      ...
      try {
        ...
        console.log("response log useroffset ", response);
