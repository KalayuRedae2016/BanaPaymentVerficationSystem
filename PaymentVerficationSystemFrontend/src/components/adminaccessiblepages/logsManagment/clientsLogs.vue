      ...
      <transition name="fade" mode="out-in">
        <div class="fixed inset-0 flex items-center justify-center z-10 bg-black bg-opacity-50">
          ...
          />
                      ...
                      <div class="space-y-4">
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            ...
                            <span class="text-sm text-gray-800">{{ $t("User Code") }}:
                        ...
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            <i class="fas fa-user text-yellow-500"></i>
                            <span class="text-sm text-gray-800">Tig Full Name :
                        ...
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            ...
                            <span class="text-sm text-gray-800">{{ $t("Gender") }}:
                        ...
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            ...
                            <span class="text-sm text-gray-800">{{ $t("Address") }}:
                      ...
                      <div class="space-y-4">
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            ...
                            <span class="text-sm text-gray-800">{{ $t("phoneNumber") }}:
                        ...
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            ...
                            <span class="text-sm text-gray-800">{{ $t("Email") }}:
                        ...
                        <div v-if="action === 'Create' || action === 'Update'" class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            <i class="fas fa-map-marker-alt text-blue-500"></i>
                            <span class="text-sm text-gray-800">{{ $t("Created at") }}:
                              {{
                                new Date(
                        ...
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            ...
                            <span class="text-sm text-white px-2 py-0.5 mb-2 rounded-full" :class="clientProfile.isActive
                                ? 'bg-blue-500'
                                : 'bg-yellow-500'
                              ">
                              {{
                        ...
                        <div v-if="clientProfile.reason" class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            <i class="fas fa-exclamation-circle text-red-500"></i>
                            <span class="text-sm text-gray-800">{{ $t("Reason") }}:
              ...
              <div v-if="action === 'Update'" class="text-sm mx-0 lg:mx-5 mt-5 mb-5">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      ...
                      <div class="space-y-4">
                        ...
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            <i class="fas fa-user text-yellow-500"></i>
                            <span class="text-sm text-gray-800">Full Name :
                        ...
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            <i class="fas fa-calendar-alt text-green-500"></i>
                            <span class="text-sm text-gray-800">{{ $t("Age") }}:
                      ...
                      <div class="space-y-4">
                        ...
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            <i class="fas fa-map-marker-alt text-blue-500"></i>
                            <span class="text-sm text-gray-800">{{ $t("Updated At") }}:
                              {{
                                new Date(
                        ...
                        <div class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            ...
                            <span class="text-sm text-black">{{ $t("Current Status") }}:</span>
                            <span class="text-sm text-white px-2 py-0.5 mb-2 rounded-full" :class="updatedClientProfile.isActive
                                ? 'bg-blue-500'
                                : 'bg-yellow-500'
                              ">
                              {{
                        ...
                        <div v-if="updatedClientProfile.reason" class="bg-white p-1 rounded-md shadow-sm">
                          <div class="flex items-center space-x-3 border-b border-gray-300">
                            <i class="fas fa-exclamation-circle text-red-500"></i>
                            <span class="text-sm text-gray-800">{{ $t("Reason") }}:
